        ...
        <footer class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-8">
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">ConseillerImmo</h3>
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Contactez-nous</h3>
                        <ul class="space-y-2">
                            ...
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-600 dark:text-gray-400">contact@conseillerimmo.fr</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                    <p class="text-center text-gray-500 dark:text-gray-400">
                        &copy; {{ new Date().getFullYear() }} ConseillerImmo. Tous droits réservés.
                    </p>
                </div>
            </div>
        </footer>
