    ...
    <div>
        ...
        <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                ...
                <template #description>
                    Ces personnes ont été invitées à rejoindre votre équipe et ont reçu un e-mail d'invitation. Elles peuvent rejoindre l'équipe en acceptant l'invitation par e-mail.
                </template>
                    ...
                    <div class="space-y-6">
                        <div v-for="user in team.users" :key="user.id" class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                ...
                                <button
                                    v-if="userPermissions.canUpdateTeamMembers && user.id !== page.props.auth.user.id"
                                ...
                                <div v-else-if="user.id !== page.props.auth.user.id" class="ml-2 text-sm text-gray-400">
                                    {{ displayableRole(user.membership.role) }}
                                </div>
        ...
        <ConfirmationModal :show="teamMemberBeingRemoved !== null" @close="teamMemberBeingRemoved = null">
            ...
            <template #content>
                Êtes-vous sûr de vouloir supprimer cette personne de l'équipe ?
            </template>
